...
MagneticSensorSoftI2C::MagneticSensorSoftI2C(uint8_t _chip_address, int _bit_resolution, uint8_t _angle_register_msb, int _bits_used_msb){
  // chip I2C address
  ...
  wire = new SoftWire(18,19);
}

MagneticSensorSoftI2C::MagneticSensorSoftI2C(MagneticSensorI2CConfig_s config){
...
void MagneticSensorSoftI2C::init(SoftWire* _wire){
  wire = _wire;
...
float MagneticSensorSoftI2C::getSensorAngle(){
...
int MagneticSensorSoftI2C::getRawCount(){
	return (int)MagneticSensorSoftI2C::read(angle_register_msb);
}
...
*/
int MagneticSensorSoftI2C::read(uint8_t angle_reg_msb) {
...
*/
int MagneticSensorSoftI2C::checkBus(byte sda_pin, byte scl_pin) {
